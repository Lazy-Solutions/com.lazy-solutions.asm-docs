...
`abstract class` in `AdvancedSceneManager.Editor.UI`  /  Inherits from: `Service_ViewModelBase`### Description
...
| `boolean Instantiate<T>(T& viewModel)` | _No documentation available._ |
| `boolean Instantiate<T>(T& viewModel, VisualElement& view)` | _No documentation available._ |
| `boolean Instantiate(Type type, ViewModel& viewModel, VisualElement& view)` | _No documentation available._ |
| `boolean Instantiate(Type type, ViewModel& viewModel)` | _No documentation available._ |
